...
import '../../police_view/drawer_page/police_profile.dart';
...
import '../judiciary_service/judiciary_navbar.dart';
import '../judiciary_service/upload_judgement.dart';

class JudiciaryHomePage extends StatefulWidget {
  const JudiciaryHomePage({Key? key}) : super(key: key);

  @override
  State<JudiciaryHomePage> createState() => _JudiciaryHomePageState();
}

class _JudiciaryHomePageState extends State<JudiciaryHomePage> {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: ()=> Get.to(()=> JudiciaryNavbar()),
                style: ElevatedButton.styleFrom(
                  primary: Colors.black.withOpacity(0.5),
                  padding: EdgeInsets.symmetric(vertical: 20),
                ),

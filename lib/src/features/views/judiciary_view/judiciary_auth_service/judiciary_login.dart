...
import 'judiciary_signup.dart';

class JudiciaryLogin extends StatefulWidget {
  const JudiciaryLogin({Key? key}) : super(key: key);

  @override
  State<JudiciaryLogin> createState() => _JudiciaryLoginState();
}

class _JudiciaryLoginState extends State<JudiciaryLogin> {
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        LoginWidget(),
                        TextButton(
                          onPressed: () => Get.to(JudiciarySignUp()),
                          child: Text.rich(
                            TextSpan(

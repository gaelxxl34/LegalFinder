...
class EditSecurityTips extends StatefulWidget {
  final Security_Tips_Model user;
  final Function refreshPage;


  EditSecurityTips({required this.user, required this.refreshPage});
  void performUpdateOrDelete()=> refreshPage();
  @override
  _EditSecurityTipsState createState() => _EditSecurityTipsState();
}

class _EditSecurityTipsState extends State<EditSecurityTips> {
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            if (selectedImagePath != '') {
                              ...
                              final users = Security_Tips_Model(
                                title: _title.text,
  ...
  Future<String> uploadImageToStorage(String imagePath, String currentImageUrl) async {
    try {
      ...
      Reference storageRef = FirebaseStorage.instance.ref().child('tips images');
